...
#  Created by Genus(TM) Synthesis Solution 16.12-s027_1 on Wed Feb 21 15:02:03 +0100 2024
...
current_design TOP_with_pads

create_clock -name "clk" -add -period 10.0 -waveform {0.0 5.0} [get_ports clk_in]
set_clock_transition -max 0.2 [get_clocks clk]
set_clock_gating_check -setup 0.0 
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[0]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[1]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[2]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[3]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[4]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[5]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[6]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {input_in[7]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports ready_in]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports reset_in]
set_input_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports clk_in]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports fini_out]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports write_done_out]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[0]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[1]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[2]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[3]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[4]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[5]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[6]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[7]}]
set_output_delay -clock [get_clocks clk] -add_delay 0.5 [get_ports {RAM_out_out[8]}]
